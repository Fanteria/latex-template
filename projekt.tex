...
\ExplSyntaxOn
  ...
  \NewDocumentCommand \wavePutter { m } {
    \input{ content/#1 }
    \wave_putter:e { #1 }
    %\wave_putter:e { \input{content/02obsah} }
...
\newcommand{\autor}{Moje jméno}
\newcommand{\skola}{Moje škola}
\newcommand{\fakulta}{Moje fakulta}
\newcommand{\nazev}{Název práce}
\newcommand{\vedouciPrace}{Vedoucí práce}
\newcommand{\typPrace}{Typ práce}
\newcommand{\misto}{Místo publikace}
...
%\include{content/03obsah}
%\myNewCommandIsIMBA{01obsah}

%\input{content/01obsah}
